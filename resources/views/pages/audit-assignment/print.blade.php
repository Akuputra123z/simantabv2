...
<head>
    ...
    <style>
        ...
        /* Struktur Section (Dasar, Kepada, Untuk) */
        .section { display: table; width: 100%; margin-bottom: 15px; }
        .label { display: table-cell; width: 95px; font-weight: bold; vertical-align: top; }
        ...
        table.tim th { border-top: 1px solid black; border-bottom: 1px solid black; text-align: left; padding: 6px 8px; font-size: 11pt; text-transform: uppercase; font-weight: bold; }
        ...
        /* Catatan Kaki */
        .footer-note { border: 1px dashed black; padding: 8px; text-align: center; font-style: italic; font-size: 9.5pt; margin-top: 60px; clear: both; font-weight: bold; }
...
<body onload="window.print()">
    ...
    <div class="container">
        <div class="kop-surat">
            <img src="{{ asset('assets/images/logo-rembang.png') }}" class="logo" alt="Logo">
            <div class="kop-text">
