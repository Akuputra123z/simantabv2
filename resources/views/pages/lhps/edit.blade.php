                        ...
                        <div class="space-y-3">
                            ...
                            <div class="mb-4 space-y-2">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                    ...
                                    <div class="flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50/80 px-3.5 py-2.5 text-xs dark:border-gray-700 dark:bg-gray-800/60">
                                        <div class="flex items-center gap-2 truncate">
                                            <svg class="h-4 w-4 shrink-0 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13"/></svg>
                                            <span class="font-medium text-gray-800 dark:text-gray-200 truncate">{{ $att->file_name }}</span>
                                        </div>
                                        <a href="{{ Storage::url($att->file_path) }}" target="_blank" class="font-semibold text-blue-600 hover:underline dark:text-blue-400 shrink-0">Unduh</a>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                                ...
                                <div class="rounded-xl border border-gray-200 bg-gray-50/50 p-4 dark:border-gray-800 dark:bg-gray-900/50 space-y-3">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" :name="`attachments[${aIdx}][file_name]`" x-model="att.file_name" placeholder="cth: Laporan Audit Tambahan (PDF)..."
