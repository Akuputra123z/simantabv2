            ...
            <form action="{{ route('recommendations.store') }}" method="POST" id="form-rekom" novalidate>
                ...
                <div class="-mx-2.5 flex flex-wrap gap-y-5">
                    ...
                    <div class="w-full px-2.5">
                        ...
                        {{-- Info detail LHP terpilih --}}
                        <div x-show="selectedLhp" x-transition
                             class="mt-2 rounded-lg border border-gray-100 bg-gray-50 px-3.5 py-3 dark:border-gray-700 dark:bg-gray-800/50">
                            <div class="flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-2">
                            ...
                            <dl class="space-y-1.5 text-xs">
                                <div class="flex gap-2">
                                    <dt class="w-24 shrink-0 font-semibold text-gray-500 dark:text-gray-400">Nomor LHP</dt>
                                    <dd class="text-gray-800 dark:text-gray-200" x-text="selectedLhp?.nomor_lhp ?? '-'"></dd>
                                </div>
                                <div class="flex gap-2">
                                    <dt class="w-24 shrink-0 font-semibold text-gray-500 dark:text-gray-400">Penugasan</dt>
                                    <dd class="text-gray-800 dark:text-gray-200" x-text="selectedLhp?.nomor_surat ?? '-'"></dd>
                                </div>
                                <div class="flex gap-2">
                                    <dt class="w-24 shrink-0 font-semibold text-gray-500 dark:text-gray-400">Unit Kerja</dt>
                                    <dd class="text-gray-800 dark:text-gray-200" x-text="selectedLhp?.unit ?? '-'"></dd>
                                </div>
                            </dl>
                        </div>
                    </div>
