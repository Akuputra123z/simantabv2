...
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]"
    ...
    <div class="px-5 py-4 sm:px-6 sm:py-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-b border-gray-100 dark:border-gray-800">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('unit-diperiksa.export', request()->query()) }}"
               class="shadow-theme-xs inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-emerald-300 bg-white px-4 text-xs font-semibold text-emerald-700 hover:bg-emerald-50 dark:border-emerald-700/60 dark:bg-emerald-950/20 dark:text-emerald-400 dark:hover:bg-emerald-900/30 transition-all cursor-pointer"
               title="Export data unit ke Excel (.xlsx)">
