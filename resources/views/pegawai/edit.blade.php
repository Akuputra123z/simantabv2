    ...
    <div class="w-full max-w-3xl">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('pegawai.' . $type . '.update', $user) }}" class="space-y-8">
                    @csrf @method('PUT')
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="form-input-styled bg-gray-50 text-sm font-semibold text-gray-700 cursor-not-allowed">
                                    OPD
                                </div>
                            </div>
                            @else
                    ...
                    <div class="pt-6 flex items-center justify-end gap-3">
                        @if($type === 'opd')
                            <a href="{{ route('pegawai.opd.index') }}" class="px-5 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all">
                                Batal
                            </a>
                        @else
                            <a href="{{ route('pegawai.inspektorat.index') }}" class="px-5 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all">
                                Batal
                            </a>
                        @endif
