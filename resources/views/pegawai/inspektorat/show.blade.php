...
<div class="min-h-screen bg-gray-50 dark:bg-gray-950 flex justify-center py-12 px-4">
    <div class="w-full max-w-xl">
        ...
        <nav class="mb-6 flex items-center gap-2 text-sm">
            <a href="{{ route('pegawai.inspektorat.index') }}" class="text-gray-400 hover:text-indigo-500 transition">
                Pegawai Inspektorat
            </a>
        ...
        <div class="rounded-2xl bg-white dark:bg-gray-900 shadow-sm ring-1 ring-gray-200 dark:ring-gray-800 overflow-hidden">
            ...
            <div class="px-6 pb-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        <p class="text-gray-400 text-xs mb-1">Pangkat / Golongan</p>
                        <p class="font-medium text-gray-800 dark:text-gray-200">
                            {{ $user->pangkat_gol ?: '—' }}
                        </p>
                    </div>
                    ...
                    <div>
                        <p class="text-gray-400 text-xs mb-1">Pendidikan Terakhir</p>
                        <p class="font-medium text-gray-800 dark:text-gray-200">
                            {{ $user->pendidikan_terakhir ?: '—' }}
                        </p>
                    </div>
                    <div>
                        <p class="text-gray-400 text-xs mb-1">Jenis Kelamin</p>
                        <p class="font-medium text-gray-800 dark:text-gray-200">
